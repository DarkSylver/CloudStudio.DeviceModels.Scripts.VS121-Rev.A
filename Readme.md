...
# Parsing + Configuration Script – VS121 - Rev. A

This **Parsing + Configuration** script is designed for the **VS121** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – VS121 Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **VS121** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
